...
from .datasets.penpot_webdataset import PenpotWebdataset
...
DATASETS_INFO_TABLE = [
    ...
    # L(WebDatasetInfo)(
    #     name="penpot",
    #     description="penpot dataset",
    #     dataset_type=DatasetType.InstructInterleavedImageText,
    #     cls=PenpotWebdataset,
    #     approx_size="1M",
    #     shard_list=megfile.smart_glob("/home/quyd/datasets/penpot-data/penpot-20240604/*.tar"),
    # ),
    L(WebDatasetInfo)(
        name="penpot",
        description="penpot dataset",
        ...
        cls=PenpotWebdataset,
        approx_size="33630",
        shard_list=megfile.smart_glob("./datasets/penpot-data/penpot-20240610/*/*.tar"),
    ),
    L(WebDatasetInfo)(
        name="laion_coco",
...
""",
        ...
        approx_size="22M",
        shard_list_path="datasets/laion_coco_shard_list.json",
    ),
    L(WebDatasetInfo)(
        name="laion2b_en",
...
""",
        ...
        cls=UnifiedITPairWebdataset,
        approx_size="15M",
        shard_list_path="datasets/blip_laion_65m_shard_list.json",
    ),
    L(WebDatasetInfo)(
...
""",
        dataset_type=DatasetType.ImageTextPair,
        cls=UnifiedITPairWebdataset,
        approx_size="21927469",
        shard_list_path="datasets/laion2B-en-aesthetic-data_22m_shard_list.json",
    ),
    L(WebDatasetInfo)(
        name="laion400m_orig",
        ...
        cls=UnifiedITPairWebdataset,
        approx_size="20M",
        shard_list_path="datasets/laion400m_origin20m_shard_list.json",
    ),
    L(WebDatasetInfo)(
        name="journeydb",
...
""",
    ...
    L(WebDatasetInfo)(
        name="laion2B_en_aesthetic_data",
        description="https://huggingface.co/datasets/laion/laion2B-en-aesthetic",
        dataset_type=DatasetType.ImageTextPair,
        cls=UnifiedITPairWebdataset,
        approx_size="2M",
        shard_list_path="data/laion2B-en-aesthetic-data.json",
    ),
    # ----------------------------------------------------------------------------------------
    ...
    L(WebDatasetInfo)(
        ...
        approx_size="7M",
        shard_list=megfile.smart_glob("datasets/mmc4-webdataset/*.tar"),
    ),
    L(WebDatasetInfo)(
        name="OmniCorpus-CC-210M",
        description="OmniCorpus-CC-210M",
        dataset_type=DatasetType.InterleavedImageText,
        cls=UnifiedInterleavedITWebdataset,
        approx_size="70K",
        shard_list=megfile.smart_glob("datasets/OmniCorpus-CC-210M/*.tar"),
    ),
    L(WebDatasetInfo)(
        name="obelics",
    ...
    L(JsonDatasetInfo)(
        ...
        approx_size="54000",
        json_list=megfile.smart_glob("datasets/mmc4_instruct/mmc4_instruct/*.json"),
        root="datasets/mmc4_instruct/mmc4_filter_fin/",
    ),
    # ----------------------------------------------------------------------------------------
    # Video-Text Pair
    # ----------------------------------------------------------------------------------------
...
More details: https://maxbain.com/webvid-dataset/""",
    ...
    L(JsonDatasetInfo)(
        ...
        approx_size="558K",
        json_path="datasets/vision-language-data/LLaVA-Pretrain/blip_laion_cc_sbu_558k.json",
        root="datasets/vision-language-data/VisionPretrainDatasets/BLIP-CCSL-558k/",
    ),
    L(JsonDatasetInfo)(
        name="gqa",
    ...
    L(JsonDatasetInfo)(
        ...
        cls=ConversationDataset,
        approx_size="665298",
        json_path="datasets/LLaVA-Instruct-150K/llava_v1_5_mix665k.json",
        root="datasets/llava_instruct/",
    ),
    L(JsonDatasetInfo)(
        ...
        cls=ConversationDataset,
        approx_size="80K",
        json_path="datasets/LLaVA-Instruct-150K/llava_instruct_80k.json",
        root="datasets/llava_instruct/coco/train2017/",
    ),
    L(JsonDatasetInfo)(
        ...
        cls=ConversationDataset,
        approx_size="1M",
        json_path="datasets/blip_laion_instruct/instruct_pair_blip_laion_22k.json",
        root="datasets/blip_laion_instruct/",
    ),
    L(JsonDatasetInfo)(
        name="instruct_laion2B-en-aesthetic",
        description="Instruction-following text-to-image generation data.",
        dataset_type=DatasetType.Conversation,
        cls=ConversationDataset,
        approx_size="6196645",
        json_path="datasets/vision-language-data/instruct_laion2B-en-aesthetic/instruct_laion2B-en-aesthetic.json",
        root="datasets/vision-language-data/instruct_laion2B-en-aesthetic/",
    ),
    L(JsonDatasetInfo)(
        name="llava_overlong",
        description="665K unique language-image instruction-following samples in total, constructed by LLaVA1.5 by mixing different VQA data.",
