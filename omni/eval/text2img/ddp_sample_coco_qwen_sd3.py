...
from diffusers import AutoencoderKL, DDIMScheduler, DDPMScheduler, StableDiffusionPipeline, UNet2DConditionModel, StableDiffusion3Pipeline
from PIL import Image
from pycocotools.coco import COCO
from torch.utils.data import DataLoader, Dataset
from tqdm import tqdm
from transformers import CLIPImageProcessor, CLIPModel, CLIPProcessor, CLIPVisionModel, AutoTokenizer
...
def dreamllm_ddp_sample_coco(
    ...
    for step in range(steps):
        ...
        for i, (image, _info, _path) in enumerate(zip(images, info, img_path)):
            ...
            print(accelerator.process_index, '\t\t', filename, '\t\t', _info["captions"])
...
def stable_ddp_sample_coco(
    ...
    # )
    pipeline = StableDiffusion3Pipeline.from_pretrained(model_name_or_path, torch_dtype=torch_dtype)
...
def caption_info(
    ...
    data_list = all_gather(data_info)
