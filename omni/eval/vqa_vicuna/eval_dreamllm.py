...
if args.evaltype == "all" or args.evaltype == "predict":
    ...
    # fmt: off
    os.system(
        "python -m omni.eval.vqa_vicuna.multi_hardware_eval" + " "
...
if args.evaltype == "all" or args.evaltype == "eval":
    ...
    if args.datatype == "mmvet":
        ...
        acc = evaluate_on_coco_caption(coco_format_file, f"./datasets/eval_vqa/eval_format_files/{args.datatype}_gt_coco_format.json")["CIDEr"] * 100
