                    ...
                    if cur_bs > 0:
                        for diffusion_idx in range(-(-cur_images.shape[0] // cur_bs)):
                            ...
                            vm_loss += cur_mini_bs * self.stable_diffusion_head(cur_images[start_idx: end_idx],
                                                                                ...
                                                                                add_time_ids[start_idx: end_idx])
                    else:
                        vm_loss += cur_images.shape[0] * self.stable_diffusion_head(cur_images, cur_encoder_hidden_states, cur_u_encoder_hidden_states, add_time_ids)
