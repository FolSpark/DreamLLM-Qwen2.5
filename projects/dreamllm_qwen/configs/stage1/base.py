...
from omni.models.dreamllm_qwen.tokenization_dreamllm import special_tokens_dict
...
# stable_diffusion_head_config_init_kwargs.projector_type = "mlp"
# stable_diffusion_head_config_init_kwargs.projector_depth = 4
