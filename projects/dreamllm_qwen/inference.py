...
output_dir = "samples/images/7B_stage1_creation_only_20241223/"
...
model_name_or_path = "work_dirs/stage1_creation_only_20241223"      # stage1_creation_only_20241114_3B_mlp
...
for i, image in enumerate(images):
    save_image(images[i], path=output_dir + f"prompt_{i}.jpg", force_overwrite=True)
