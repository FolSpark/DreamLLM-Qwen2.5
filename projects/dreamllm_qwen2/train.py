...
from omni.data.builders.builder_dreamllm_qwen2 import DataCollatorForDreamLLMDataset, DreamLLMDataset
from omni.models.dreamllm_qwen2.configuration_dreamllm import ConfigAndInitKwargs, DreamLLMConfig
...
def train():
    ...
    train_dataset = DreamLLMDataset(
        ...
        tokenizer=tokenizer,
        vision_encoder_processor=getattr(model.get_decoder(), "vision_encoder").processor,
        stable_diffusion_head_processor=getattr(model, "stable_diffusion_head").processor,
        vision_embedding_len=getattr(model.get_decoder(), "vision_encoder").embed_len,
