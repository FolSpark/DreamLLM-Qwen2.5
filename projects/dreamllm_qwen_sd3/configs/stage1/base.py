...
from ..common import (
    ...
    local_files_only,
    stable_diffusion3_head_config_init_kwargs,
)
...
stable_diffusion3_head_config_init_kwargs.embed_hidden_size = hidden_size
...
# Diffusion Decoder
stable_diffusion3_head_config_init_kwargs.freeze_vae = True
stable_diffusion3_head_config_init_kwargs.freeze_transformer = True
stable_diffusion3_head_config_init_kwargs.freeze_projector = False
...
config.model = dict(
    ...
    plugins_config_init_kwargs=dict(
        ...
        stable_diffusion3_head=stable_diffusion3_head_config_init_kwargs,
    ),
)
