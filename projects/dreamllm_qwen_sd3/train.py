...
# from omni.models.dreamllm_qwen.tokenization_dreamllm import DreamLLMTokenizer as AutoTokenizer
...
from omni.models.dreamllm_qwen_sd3.configuration_dreamllm import ConfigAndInitKwargs, DreamLLMConfig
from omni.models.dreamllm_qwen_sd3.modeling_dreamllm import DreamLLMForCausalMLM
...
def train():
    ...
    if config.data.use_bucket:
        ...
        data_collator = DataCollatorForDreamLLMDataset(tokenizer, config.data.bucket_config, getattr(model, "stable_diffusion3_head").processor_size)
    else:
    ...
    train_dataset = DreamLLMDataset(
        ...
        stable_diffusion_head_processor=getattr(model, "stable_diffusion3_head").processor,
