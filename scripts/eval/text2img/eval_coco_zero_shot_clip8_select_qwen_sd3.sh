...
NUM_PROCESSES=2
# out_dir="dreamllm-7b-chat-v1.0_30k_1"
# model_name_or_path="models/dreamllm-7b-chat-v1.0"
# out_dir="dreamllm-7b-chat-aesthetic-v1.0"
# model_name_or_path="models/dreamllm-7b-chat-aesthetic-v1.0"
# out_dir="stage1_creation_only_20241015_clip8_select"    # 8层小模型，只跑了42一次，FID:  51.498751303683264
# model_name_or_path="models/stage1_complete/stage1_creation_only_20241013-from_compre_only_20241013_ckpt25k/checkpoint-25000"
# out_dir="our_train_stage3_llava_30k_1"
# model_name_or_path="models/our_train/stage3_20241019-from_stage2_20241016"
out_dir="sd3.5_stage1_creation_only_20241216"
...
accelerate launch --num_processes ${NUM_PROCESSES} omni/eval/text2img/ddp_sample_coco_qwen_sd3.py \
--type caption \
--coco_root ${COCO_ROOT} \
