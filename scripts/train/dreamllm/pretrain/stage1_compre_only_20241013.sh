...
RUN_NAME="stage1_compre_only_20241013"
SEED=42
...
mpirun --allow-run-as-root -np $NP \
    ...
    python ${DIR}/projects/dreamllm/train.py \
        ...
        "model.plugins_config_init_kwargs.dream_embedding.pretrained_model_name_or_path=NotSpecified" 2>&1 | tee "./work_dirs/${RUN_NAME}/training-mpirun.log"
