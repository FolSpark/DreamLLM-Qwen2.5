...
PRETRAIN_CLIP_MODEL_PATH="work_dirs/stage1_compre_only_20241013/checkpoint-25000"
PRETRAIN_SD_MODEL_PATH="work_dirs/stage1_compre_only_20241013/checkpoint-25000"
PRETRAIN_DREAM_EMBEDDING_PATH="work_dirs/stage1_compre_only_20241013/checkpoint-25000"
RUN_NAME="stage1_creation_only_20241013-from_compre_only_20241013_ckpt25k"
SEED=42
...
mpirun --allow-run-as-root -np $NP \
    ...
    python ${DIR}/projects/dreamllm/train.py \
        ...
        "data.datasets=['llava_pretrain', 'laion400m_orig', 'laion_coco', 'blip_laion']" \
        "data.size_list=['558K', '11M', '11M', '8M']" \
        "data.datasets_approx_sizes=['558K', '20M', '22M', '15M']" \
