...
# MODEL_NAME_OR_PATH="work_dirs/stage1_compre_only_20241113"
MODEL_NAME_OR_PATH="models/Qwen2.5-1.5B-Instruct"

# PRETRAIN_CLIP_MODEL_PATH="work_dirs/stage1_compre_only_20241113"
# PRETRAIN_SD_MODEL_PATH="work_dirs/stage1_compre_only_20241113"
# PRETRAIN_DREAM_EMBEDDING_PATH="work_dirs/stage1_compre_only_20241113"
PRETRAIN_CLIP_MODEL_PATH="NotSpecified"
PRETRAIN_SD_MODEL_PATH="NotSpecified"
PRETRAIN_DREAM_EMBEDDING_PATH="NotSpecified"

RUN_NAME="stage1_qwen_20241214"
SEED=42
TRAIN_EPOCH=1
DEVICE_BATCH_SIZE=8
...
"data.datasets=['blip_laion', 'llava_pretrain']" \
"data.size_list=['1M', '558K']" \
"data.datasets_approx_sizes=['5.8M', '558K']" \
