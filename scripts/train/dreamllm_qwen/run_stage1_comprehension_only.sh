...
MODEL_NAME_OR_PATH="work_dirs/stage1_creation_only_20241114_32"

PRETRAIN_CLIP_MODEL_PATH="work_dirs/stage1_creation_only_20241114_32"
PRETRAIN_SD_MODEL_PATH="work_dirs/stage1_creation_only_20241114_32"
PRETRAIN_DREAM_EMBEDDING_PATH="work_dirs/stage1_creation_only_20241114_32"

RUN_NAME="stage1_compre_only_20241115"
SEED=42
TRAIN_EPOCH=1
...
--config_file projects/dreamllm_qwen/configs/stage1/vicuna11_7b_llavapretran_comprehension_only.py \
...
"model.plugins_config_init_kwargs.dream_embedding.num_dream_queries=32" \
