...
MODEL_NAME_OR_PATH="work_dirs/InternViT_sd3.5_512_q256_stage1_compre_only_20250216_from_creation_only_20250117"

PRETRAIN_InternViT_MODEL_PATH="work_dirs/InternViT_sd3.5_512_q256_stage1_compre_only_20250216_from_creation_only_20250117"
PRETRAIN_SD_MODEL_PATH="work_dirs/InternViT_sd3.5_512_q256_stage1_compre_only_20250216_from_creation_only_20250117"
PRETRAIN_DREAM_EMBEDDING_PATH="work_dirs/InternViT_sd3.5_512_q256_stage1_compre_only_20250216_from_creation_only_20250117"

RUN_NAME="InternViT_sd3.5_512_q256_stage2_20250220_from_stage1_20250216"
SEED=42
TRAIN_EPOCH=1
DEVICE_BATCH_SIZE=8
...
mpirun --allow-run-as-root -np $NP \
    ...
    python ${DIR}/projects/dreamllm_qwen_sd3_InternViT/train.py \
        --config_file projects/dreamllm_qwen_sd3_InternViT/configs/stage2/base.py \
